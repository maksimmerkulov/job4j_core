...
/*
  ...
  положительные четные двузначные числа до 19 в порядке возрастания. Перед
  началом вывода нужно вывести слово "Начало" в отдельной строке, а после
  окончания вывода чисел - слово "Конец", тоже в отдельной строке.
