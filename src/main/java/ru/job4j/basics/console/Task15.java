...
/*
  ...
  Напишите класс, который анализирует входящую строку и выводит на экран в
  первой строке три раза первый символ, во второй строке - четыре раза второй
  символ, и в третьей - два раза третий символ. Например, для входящей строки
