...
/*
  ...
  Обратите внимание метод System.out.println, имеет в конце ln, что с
  английского значит line, что подразумевает вывод с переходом на новую строку.
  Существует другой метод System.out.print, т.е. без ln. Он не переводит на
  новую строку. Пример,
